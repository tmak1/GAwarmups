...
array_of_strings = ["Mallard", "Hook Bill", "African", "Crested", "Pilgrim", "Toulouse", "Blue Swedish"]

p array_of_strings

def goose_filter(array_of_strings, geese)
    return array_of_strings.select do |elem| 
        !geese.include?(elem);
    end
end

p goose_filter(array_of_strings, geese)